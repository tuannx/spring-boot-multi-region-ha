...
results. GitHub Actions uses the v0.3.0 analysis action with the latest
released Python package, 0.3.0.
...
action and Python package version `0.3.0` with the same production source root:
