...
public class RabbitMqQueueListenerContainer implements QueueListenerContainer, MessageListener {
    ...
    public RabbitMqQueueListenerContainer(
        ...
        this.delegate.setPrefetchCount(properties.getPrefetchCount());
        this.delegate.setRecoveryInterval(properties.getRecoveryIntervalMs());
        this.delegate.setReceiveTimeout(properties.getVisibilityTimeoutMs());
    }
